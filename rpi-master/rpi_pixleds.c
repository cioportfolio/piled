...
#define LED_NCHANS      7   // Number of LED channels (8 or 16)
...
#define CHAN_MAXLEDS    225  // Maximum number of LEDs per channel
...
int on_rgbs[16] = {0xff0000, 0x00ff00, 0x0000ff, 0xff0000,
                  0xff4040, 0x40ff40, 0x4040ff, 0x400000,
                  0xff0000, 0x00ff00, 0x0000ff, 0x00ff00,
                  0xff4040, 0x40ff40, 0x4040ff, 0x004000};
int off_rgbs[16];
